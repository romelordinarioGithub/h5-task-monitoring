...
function ThreadInput({
  ...
  const { handleModal, setIsEditingThread } = useContext(TicketContext);
    ...
    >
      ...
      <Box width="100%">
        <Editor
          ...
          isDisabled={isSaving}
        />
        <Stack direction="row" justifyContent="start" spacing={0.5} mt={2}>
          ...
          <Stack direction="row-reverse" width="100%" spacing={1}>
            <Button
              variant="contained"
              sx={{

import { Box, SimpleGrid, Skeleton, Table } from '@mantine/core';

type TaskViewSectionSkeletonProps = {
  tableHeight?: number | null;
};

export function TaskViewSectionSkeleton({ tableHeight }: TaskViewSectionSkeletonProps) {
  return (
    <>
      <Box>
